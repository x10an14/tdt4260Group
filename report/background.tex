...
The simplest of the two prefetchers is the Sequential prefetcher, which fetches
the next block of data \cite{seq}. The Tagged Sequential prefetcher is a slight
...
mark the cache blocks that have been prefetched. The tagging system is used to
...
matches, we choose the longest match.
\todo[inline]{Re-phrase ``we choos the longest match''?? -C}
