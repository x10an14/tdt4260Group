...
We use the M5 simulator to simulate a processor running SPEC CPU2000 running
benchmark programs with our implemented prefetcher with different values for
