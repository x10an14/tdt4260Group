...
To optimize the tagged sequential prefetcher, both the \emph{distance} and the
\emph{degree} was varied. The DCPT prefetcher was optimized by changing
\emph{table size}, \emph{delta size}, \emph{delta ring buffer size}, and
\emph{maximum degree}. For both prefetchers, several simulations with different
combinations of these parameters were run to check for patterns.
