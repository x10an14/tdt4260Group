...
\todo[inline]{Describing the simulator setup and config values. \\ Describe the
``default simulator setup'' better. Explicitly state the conditions of the
default simulator. Don't simply say ``can be studied there.''}
...
\todo[inline]{Describing our TS implementation. \\
